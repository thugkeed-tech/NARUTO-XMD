...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for NARUTO-XMD bot",
    category: "download",
    use: ".pair +27655xxxxxxx",
    filename: __filename
    ...
    try {
        ...
        const doneMessage = "> *NARUTO  -XMD PAIRING COMPLETED*";
...
cmd({
    ...
    try {
        ...
        const pairingCode = response.data.code;
        const doneMessage = "> *HAIKO-MDX-V2 PAIRING COMPLETED*";
